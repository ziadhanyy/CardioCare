...
def main():
    ...
    ChestPainType = st.selectbox('Chest Pain Type', ['1', '2', '3', '4'], index=0)
    Cholesterol = st.number_input('Cholesterol (mg/dl)', min_value=0, max_value=600, step=1, value=200)
    FastingBS = st.selectbox('Fasting Blood Sugar (mg/dl)', ['0', '1'], index=0)
    MaxHR = st.number_input('Maximum Heart Rate', min_value=0, max_value=300, step=1, value=150)
